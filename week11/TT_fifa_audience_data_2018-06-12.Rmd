...
#"United Kingdom" is too long to be a tidy label
top10[6, 1] <- "UK"

fifaplot2 <- fifaplot + geom_text_repel(data = top10, aes(x = population_share, y = tv_audience_share, label = country), box.padding = 1.5, point.padding = 0.6)
```

```{r}
ggsave("FIFA World Cup 2010 Viewership.png", plot = fifaplot2, device = "png", dpi = 300, path = "C:/Users/Hayden/Downloads")
```
